...
import com.core.framework.image.universalimageloader.cache.disc.DiscCacheAware;
import com.core.framework.image.universalimageloader.cache.disc.naming.FileNameGenerator;
import com.core.framework.image.universalimageloader.cache.memory.MemoryCacheAware;
import com.core.framework.image.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.core.framework.image.universalimageloader.core.assist.MemoryCacheUtil;
import com.core.framework.image.universalimageloader.core.assist.QueueProcessingType;
import com.core.framework.image.universalimageloader.core.decode.ImageDecoder;
import com.core.framework.image.universalimageloader.core.download.ImageDownloader;
import com.core.framework.image.universalimageloader.core.download.NetworkDeniedImageDownloader;
import com.core.framework.image.universalimageloader.core.download.SlowNetworkImageDownloader;
 ...
 * @since 1.0.0
 * @see ImageLoader
 * @see com.tuan800.framework.image.universalimageloader.cache.memory.MemoryCacheAware
 * @see com.tuan800.framework.image.universalimageloader.cache.disc.DiscCacheAware
 * @see DisplayImageOptions
 * @see download.ImageDownloader
 * @see com.tuan800.framework.image.universalimageloader.cache.disc.naming.FileNameGenerator
 */
public final class ImageLoaderConfiguration {
	 ...
	 * <li>threadPoolSize = {@link ImageLoaderConfiguration.Builder#DEFAULT_THREAD_POOL_SIZE this}</li>
	 * <li>threadPriority = {@link ImageLoaderConfiguration.Builder#DEFAULT_THREAD_PRIORITY this}</li>
	 ...
	 * <li>discCache = {@link com.tuan800.framework.image.universalimageloader.cache.disc.impl.UnlimitedDiscCache}</li>
	 ...
	 * <li>tasksProcessingOrder = {@link assist.QueueProcessingType#FIFO}</li>
	...
	public static class Builder {
		 ...
		 * @param processorForDiscCache null-ok; {@linkplain process.BitmapProcessor Bitmap processor} which process images before saving them in disc cache
		 */
		 ...
		 * <li>{@link #tasksProcessingOrder( assist.QueueProcessingType)}</li>
		 * </ul>
		 *
		 ...
		 * {@linkplain #taskExecutorForCachedImages(java.util.concurrent.Executor) tasks about cached images} then these tasks will be in the
		 ...
		 * Default value - {@link assist.QueueProcessingType#FIFO}
		 */
		 ...
		 * {@link com.tuan800.framework.image.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 * memory cache. You can use {@link #memoryCache( com.tuan800.framework.image.universalimageloader.cache.memory.MemoryCacheAware)} method to set your own implementation of
		 * {@link com.tuan800.framework.image.universalimageloader.cache.memory.MemoryCacheAware}.
		 */
		 ...
		 * Default value - {@link com.tuan800.framework.image.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.tuan800.framework.image.universalimageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache( com.tuan800.framework.image.universalimageloader.cache.disc.DiscCacheAware)} method for introduction your own
		 * implementation of {@link com.tuan800.framework.image.universalimageloader.cache.disc.DiscCacheAware}
		 */
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.tuan800.framework.image.universalimageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache( com.tuan800.framework.image.universalimageloader.cache.disc.DiscCacheAware)} method for introduction your own
		 * implementation of {@link com.tuan800.framework.image.universalimageloader.cache.disc.DiscCacheAware}
		 */
		 ...
		 * Default value - {@link com.tuan800.framework.image.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.tuan800.framework.image.universalimageloader.utils.StorageUtils#getCacheDirectory(android.content.Context)
		 ...
		 * <li>{@link #discCacheFileNameGenerator( com.tuan800.framework.image.universalimageloader.cache.disc.naming.FileNameGenerator)}</li>
		 * </ul>
		 */
