...
import com.core.framework.image.universalimageloader.core.display.FakeBitmapDisplayer;
...
//	}
	 ...
	 * @param uri       Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param imageView {@link android.widget.ImageView} which should display image
	 * @param listener  {@linkplain assist.ImageLoadingListener Listener} for image loading process. Listener fires events on UI
	 *                  thread.
	 * @throws IllegalStateException    if {@link #init( ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageView</b> is null
	 */
...
//                listener.onLoadingComplete(uri.url, imageView, bmp);
	 ...
	 * {@link assist.ImageLoadingListener#onLoadingComplete(String, android.view.View, android.graphics.Bitmap)} callback}.<br />
	 * <b>NOTE:</b> {@link #init( ImageLoaderConfiguration)} method must be called before this method call
	 *
	 * @param uri      Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param listener {@linkplain assist.ImageLoadingListener Listener} for image loading process. Listener fires events on UI
	 ...
	 *
	 * @param uri          Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param minImageSize Minimal size for {@link android.graphics.Bitmap} which will be returned in
	 *                     {@linkplain assist.ImageLoadingListener#onLoadingComplete(String, android.view.View, android.graphics.Bitmap)} callback}. Downloaded image will be decoded
	 *                     and scaled to {@link android.graphics.Bitmap} of the size which is <b>equal or larger</b> (usually a bit larger) than
	 ...
	 *                 {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions( DisplayImageOptions) from
	 *                 configuration} will be used.<br />
	 *                 Incoming options should contain {@link display.FakeBitmapDisplayer} as displayer.
	 * @param listener {@linkplain assist.ImageLoadingListener Listener} for image loading process. Listener fires events on UI
	 *                 thread.
	 * @throws IllegalStateException if {@link #init( ImageLoaderConfiguration)} method wasn't called before
	 */
	...
	/** Returns URI of image which is loading at this moment into passed {@link android.widget.ImageView} */
	public String getLoadingUriForView(ImageView imageView) {
		return engine.getLoadingUriForView(imageView);
	}

	/**
	 * Cancel the task of loading and displaying image for passed {@link android.widget.ImageView}.
	 *
	 * @param imageView {@link android.widget.ImageView} for which display task will be cancelled
	 */
	 ...
	 * {@link assist.ImageLoadingListener#onLoadingFailed(String, android.view.View, assist.FailReason)} callback will be fired with
	 * {@link assist.FailReason.FailType#NETWORK_DENIED}
	 *
	...
	/**
	 * Sets option whether ImageLoader will use {@link assist.FlushedInputStream} for network downloads to handle <a
	 * href="http://code.google.com/p/android/issues/detail?id=6066">this known problem</a> or not.
	 *
	 * @param handleSlowNetwork pass <b>true</b> - to use {@link assist.FlushedInputStream} for network downloads; <b>false</b>
	 *                          - otherwise.
	 */
