...
public final class MemoryCacheUtil {
	...
	public static String generateKey(String imageUri, ImageSize targetSize) {
		...
		{
			return new StringBuilder().append(URI_AND_SIZE_SEPARATOR).append(targetSize.getWidth()).append(WIDTH_AND_HEIGHT_SEPARATOR).append(targetSize.getHeight()).toString();
		}
	}
	 ...
	 * {@link com.tuan800.framework.image.universalimageloader.core.ImageLoaderConfiguration.Builder#denyCacheImageMultipleSizesInMemory()
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain com.tuan800.framework.image.universalimageloader.core.ImageLoaderConfiguration configuration}
	 */
