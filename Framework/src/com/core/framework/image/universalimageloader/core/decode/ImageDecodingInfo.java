...
import com.core.framework.image.universalimageloader.core.assist.ViewScaleType;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.tuan800.framework.image.universalimageloader.core.assist.MemoryCacheUtil#generateKey(String, com.tuan800.framework.image.universalimageloader.core.assist.ImageSize) image key} (used in memory cache). */
	...
	/**
	 * @return Target size for image. Decoded bitmap should close to this size according to {@linkplain com.tuan800.framework.image.universalimageloader.core.assist.ImageScaleType
	 *         image scale type} and {@linkplain com.tuan800.framework.image.universalimageloader.core.assist.ViewScaleType view scale type}.
	 */
	...
	/**
	 * @return {@linkplain com.tuan800.framework.image.universalimageloader.core.assist.ImageScaleType Scale type for image sampling and scaling}. This parameter affects result size
	 *         of decoded bitmap.
	 */
	...
	/** @return {@linkplain com.tuan800.framework.image.universalimageloader.core.assist.ViewScaleType View scale type}. This parameter affects result size of decoded bitmap. */
