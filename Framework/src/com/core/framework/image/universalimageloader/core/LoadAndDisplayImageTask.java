...
import com.core.framework.image.universalimageloader.core.assist.FailReason.FailType;
...
import com.core.framework.image.universalimageloader.core.decode.ImageDecodingInfo;
 ...
 * display it in {@link android.widget.ImageView} using {@link DisplayBitmapTask}.
 *
...
final class LoadAndDisplayImageTask implements Runnable {
	 ...
	 * moment and fire {@link assist.ImageLoadingListener#onLoadingCancelled(String, android.view.View)}} event if it doesn't.
	 */
