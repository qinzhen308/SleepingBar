...
/**
 * Displays {@link android.graphics.Bitmap} in {@link android.widget.ImageView}. Implementations can apply some changes to Bitmap or any animation for
...
public interface BitmapDisplayer {
	/**
	 * Display bitmap in {@link android.widget.ImageView}. Displayed bitmap should be returned.<br />
	 * <b>NOTE:</b> This method is called on UI thread so it's strongly recommended not to do any heavy work in it.
	 *
	 * @param bitmap     Source bitmap
	 * @param imageView  {@linkplain android.widget.ImageView Image view} to display Bitmap
	 * @param loadedFrom Source of loaded image
	 * @return Bitmap which was displayed in {@link android.widget.ImageView}
	 */
