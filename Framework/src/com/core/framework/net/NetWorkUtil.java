...
public class NetWorkUtil {
    ...
    public static String getProvider() {
        String provider = "未知";
        try {
            TelephonyManager telephonyManager = (TelephonyManager) MyApplication.getInstance().getBaseContext()
    ...
    private static int getNetworkClass() {
        ...
        try {
            final NetworkInfo network = ((ConnectivityManager)  MyApplication.getInstance().getBaseContext()
                    .getSystemService(Context.CONNECTIVITY_SERVICE))
            ...
            if (network != null && network.isAvailable()
                ...
                if (type == ConnectivityManager.TYPE_WIFI) {
                    ...
                    TelephonyManager telephonyManager = (TelephonyManager)  MyApplication.getInstance().getBaseContext().getSystemService(
    ...
    public static String getWifiRssi() {
        ...
        try {
            ...
            if (network != null && network.isAvailable()
                ...
                int type = network.getType();
                if (type == ConnectivityManager.TYPE_WIFI) {
                    WifiManager wifiManager = (WifiManager)  MyApplication.getInstance().getBaseContext()
                            .getSystemService(Context.WIFI_SERVICE);
    ...
    public static String getImei() {
        TelephonyManager mTelephonyMgr = (TelephonyManager)  MyApplication.getInstance().getBaseContext()
                .getSystemService(Context.TELEPHONY_SERVICE);
