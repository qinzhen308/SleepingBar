...
public class CashDealWraper implements BeanWraper<CashDeal>{
	
	/**
	 * 
	 */
    public List<CashDeal> account; //  当前页面所有的beans 
    ...
    @Override
    public List<CashDeal> getItems(){
    	if(account==null){
    		account=new ArrayList<CashDeal>();
    	}
    	return account;
    }
