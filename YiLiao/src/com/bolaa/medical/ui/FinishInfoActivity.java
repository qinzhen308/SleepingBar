...
import com.bolaa.medical.utils.ImageUtil;
import com.bolaa.medical.view.CircleImageView;
import com.bolaa.medical.view.wheel.NumericWheelAdapter;
import com.bolaa.medical.view.wheel.OnWheelScrollListener;
import com.bolaa.medical.view.wheel.WheelView;
...
public class FinishInfoActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setActiviyContextView(R.layout.activity_finish_info);
		setTitleTextRightText("", "完善个人信息", "跳过", true);
		mBirthday = "";
		initView();
		setListener();
	}
	...
	private void initView() {
		...
		mNameTv = (EditText) findViewById(R.id.et_name);
		mBirthTv = (TextView) findViewById(R.id.tv_birthday);
		mSexTv = (TextView) findViewById(R.id.tv_sex);
		mIDCardTv = (EditText) findViewById(R.id.et_id_card);
	...
	private void initData() {
		...
		if (mUserInfo != null) {
			...
			mIconIv.setImageResource(R.drawable.user2);
			setText("", mNameTv);
			setText("", mBirthTv);
			setText("", mSexTv);
		}
	...
	private void updateInfo() {
		...
		String real_name=mNameTv.getText().toString().trim();
...
//			return;
		...
		String id_card=mIDCardTv.getText().toString().trim();
		if (id_card .length()>0) {
...
//			return;
	...
	public static void invoke(Context context){
		Intent intent=new Intent(context , FinishInfoActivity.class);
