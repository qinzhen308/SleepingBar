...
public class CashHistoryActivity extends BaseListActivity implements OnLoadErrorListener,OnRefreshListener{
	...
	private void initView(){
		...
		mAdapter=new CashHistoryAdapter(this);
	...
	private void initData(boolean isRefresh){
		...
		if(isRefresh){
			immediateLoadData(APIUtil.parseGetUrlHasMethod(params.getParamList(), AppUrls.getInstance().URL_CASH_HISTORY), CashDealWraper.class);
		}else {
			reLoadData(APIUtil.parseGetUrlHasMethod(params.getParamList(), AppUrls.getInstance().URL_CASH_HISTORY), CashDealWraper.class);
		}
	}
	...
	public static void invoke(Context context){
		Intent intent=new Intent(context,CashHistoryActivity.class);
